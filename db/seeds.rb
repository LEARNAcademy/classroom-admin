...
# Update Delta assessments
cohort = Cohort.find_by(cohort_name: "Bravo")
all_bravo_students = cohort.students
all_bravo_students.each do |student|
  3.times do |i|
    student.assessments[i].update(status: 2, comprehension: 3, reviewer: Faker::Name.unique.first_name, notes: Faker::Lorem.paragraph)
  end
end
