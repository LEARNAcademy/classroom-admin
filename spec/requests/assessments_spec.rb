...
RSpec.describe "/assessments", type: :request do
  ...
  # AssessmentsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get assessments_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    ...
    context "with invalid parameters" do
      it "does not create a new Assessment" do
        expect {
          post assessments_url,
            params: {assessment: invalid_attributes}, as: :json
        }.to change(Assessment, :count).by(0)
      end

      it "renders a JSON response with errors for the new assessment" do
        post assessments_url,
          params: {assessment: invalid_attributes}, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested assessment" do
      assessment = Assessment.create! valid_attributes
      expect {
        delete assessment_url(assessment), headers: valid_headers, as: :json
      }.to change(Assessment, :count).by(-1)
    end
  end
end
